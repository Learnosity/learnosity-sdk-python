...
with open('/Users/palashshinde/learnosity/learnosity-sdk-python/sandbox/question_answer_dump.json', 'r') as f:
    student_data = f.read()

# 2. Define the System Prompt (The one provided above)
system_instruction = """
# ROLE
...
response = client.chat.completions.create(
  ...
  response_format={"type": "json_object"} # Important for strict JSON
)
